...
from aad.utils import import_class, count_params
from aad.models.proposed.ms_gcn import MultiScale_GraphConv as MS_GCN
...
class Model(nn.Module):
    def __init__(self,
        ...
        # r=3 STGC blocks
        self.gcn3d1 = MultiWindow_MS_G3D(1, c1, A_binary, num_g3d_scales, window_stride=1)
        self.sgcn1 = nn.Sequential(
            MS_GCN(num_gcn_scales, 1, c1, A_binary, disentangled_agg=True),
            MS_TCN(c1, c1),
            MS_TCN(c1, c1))
